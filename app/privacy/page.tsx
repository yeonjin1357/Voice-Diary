    ...
    <MobileLayout header={header}>
      <div className="px-4 py-6">
        <div className="prose prose-sm max-w-none">
          <p className="text-sm text-gray-600">최종 수정일: 2024년 1월 28일</p>

          <h2 className="mt-6 text-lg font-semibold">1. 개인정보의 수집 및 이용 목적</h2>
          <p className="mt-2 text-sm leading-relaxed text-gray-700">
            Voice Diary(이하 &apos;서비스&apos;)는 다음과 같은 목적으로 개인정보를 수집하고 이용합니다:
          </p>
          ...
          <h2 className="mt-6 text-lg font-semibold">2. 수집하는 개인정보 항목</h2>
          <ul className="mt-2 list-disc space-y-1 pl-5 text-sm text-gray-700">
            <li>이메일 주소 (회원가입 시)</li>
          ...
          <h2 className="mt-6 text-lg font-semibold">3. 개인정보의 보유 및 이용 기간</h2>
          <ul className="mt-2 list-disc space-y-1 pl-5 text-sm text-gray-700">
          ...
          <h2 className="mt-6 text-lg font-semibold">5. 개인정보의 처리 위탁</h2>
          <p className="mt-2 text-sm leading-relaxed text-gray-700">
            서비스는 원활한 서비스 제공을 위해 다음과 같이 개인정보 처리를 위탁합니다:
          </p>
          <ul className="mt-2 list-disc space-y-1 pl-5 text-sm text-gray-700">
            <li>OpenAI: 음성-텍스트 변환 및 감정 분석 (음성 데이터는 변환 후 즉시 삭제)</li>
          ...
          <h2 className="mt-6 text-lg font-semibold">7. 개인정보의 안전성 확보 조치</h2>
          <ul className="mt-2 list-disc space-y-1 pl-5 text-sm text-gray-700">
            <li>SSL 암호화 통신</li>
            <li>비밀번호 암호화 저장</li>
            <li>정기적인 보안 업데이트</li>
